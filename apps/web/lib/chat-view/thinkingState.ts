...
interface LatestThinkingPanelAutoCollapseOptions {
  hasThinkingText: boolean;
  hasAssistantText: boolean;
}

export function canAutoCollapseLatestThinkingPanel(
  options: LatestThinkingPanelAutoCollapseOptions,
): boolean {
  return options.hasThinkingText && options.hasAssistantText;
}
