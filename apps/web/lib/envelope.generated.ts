...
export type BusAction = 'PING' | 'AGENT_SEND' | 'HUMAN_RESPONSE' | 'CONFIG_GET' | 'CONFIG_UPDATE' | 'MEMORY_QUERY' | 'MEMORY_ARCHIVE' | 'LIST_FILES' | 'BASH_EXEC' | 'SCRIPT_EXEC' | 'SCREEN_SHOT' | 'MOUSE_CLICK' | 'BROWSER_QUERY';
