...
data class SessionRunState(
    ...
    @SerialName("updated_at")
    val updatedAt: String,
    @SerialName("terminal_at")
    val terminalAt: String
)

@Serializable
data class SessionRunStatesGetRequest(
    val limit: Int? = null,
...
@Serializable
data class SessionRuntimeSelection(
    val runtime: String,
...
data class SessionDetail(
    ...
    @SerialName("token_count")
    val tokenCount: Int,
    @SerialName("last_runtime_selection")
    val lastRuntimeSelection: SessionRuntimeSelection? = null,
    @SerialName("turn_draft")
    val turnDraft: SessionTurnDraft? = null
)

@Serializable
data class SessionAppendMessage(
    val role: String,
    val text: String
)

@Serializable
data class SessionAppendRequest(
    @SerialName("session_id")
    val sessionId: String,
    @SerialName("expected_head")
    val expectedHead: Int? = null,
    val title: String? = null,
    val messages: List<SessionAppendMessage>,
    @SerialName("trace_id")
    val traceId: String? = null
)

@Serializable
data class SessionAppendResponse(
    @SerialName("session_id")
    val sessionId: String,
    val status: String,
    @SerialName("message_count")
