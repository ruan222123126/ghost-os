...
func NewEvolver(config MemoryConfig, warm *WarmMemory, cold *ColdMemory, graph *GraphService, summarizer Summarizer, metrics *memoryCounters) *Evolver {
	return &Evolver{
		...
		graph:              graph,
		summarizer:         summarizer,
		warmTTL:            config.Warm.TTL,
		anchorEnabled:      config.Warm.AnchorEnabled,
		anchorMinWeight:    config.Warm.AnchorMinWeight,
		evolutionEnabled:   config.Warm.EvolutionEnabled,
		evolutionInterval:  config.Warm.EvolutionInterval,
		evolutionUseWorker: config.Warm.EvolutionUseWorker,
		evolutionBatchSize: config.Warm.EvolutionBatchSize,
		metrics:            metrics,
