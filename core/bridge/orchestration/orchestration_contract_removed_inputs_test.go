...
func TestOrchestrationRemovedBoundaryNodesAreRejected(t *testing.T) {
	task := ScheduledTask{
		TaskKind:      taskKindOrchestration,
		Name:          "removed-boundary-orchestration",
		Orchestration: buildRemovedBoundaryDefinition(orchestrationModeSequential, 1),
	}
...
func buildRemovedBoundaryDefinition(mode string, maxRounds int) *OrchestrationDefinition {
