...
func loadConfigWithRuntime(runtime runtimeConfig) (Config, error) {
	...
	cfg := Config{
		...
		RSSFeedsPath:                                 rssFeedsPathFromEnv(),
		RSSInboxPath:                                 rssInboxPathFromEnv(),
		RSSPollEnabled:                               rssPollEnabledFromEnv(),
		RSSPollInterval:                              rssPollIntervalFromEnv(),
		RSSPollMaxItemsPerFeed:                       rssPollMaxItemsPerFeedFromEnv(),
		RSSAIBatchSize:                               rssAIBatchSizeFromEnv(),
		MemoryWarmPath:                               memoryWarmPathFromEnv(),
		MemoryColdPath:                               memoryColdPathFromEnv(),
		MemoryLedgerPath:                             memoryLedgerPathFromEnv(),
		MemoryLedgerDualWrite:                        memoryLedgerDualWriteFromEnv(),
		MemoryLedgerReadEnabled:                      memoryLedgerReadEnabledFromEnv(),
		MemoryLedgerShadowCompare:                    memoryLedgerShadowCompareFromEnv(),
