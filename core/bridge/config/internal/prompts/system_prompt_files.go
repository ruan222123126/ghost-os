...
const (
	SystemPromptDirName          = systemPromptDirName
	SystemPromptFileExt          = systemPromptFileExt
	SystemPromptJSONExt          = systemPromptJSONExt
	SystemPromptInitFile         = systemPromptInitFile
	SystemPromptDirPerm          = systemPromptDirPerm
	SystemPromptFilePerm         = systemPromptFilePerm
	SystemPromptCorePromptKey    = systemPromptCorePromptKey
	SystemPromptPromptLibraryKey = systemPromptPromptLibraryKey
)
...
// LoadSystemPromptFiles initializes and reads the current system prompt files.
