...
class EmittersTest(unittest.TestCase):
    ...
    def test_go_renderer_uses_schema_metadata(self) -> None:
        ...
        self.assertIn("type taskListParams = api.TaskListParams", rendered)
        self.assertIn("type taskRunNowParams = api.TaskRunNowParams", rendered)
        self.assertIn("type taskStopParams = api.TaskStopParams", rendered)
        self.assertIn("type TaskListParams = taskListParams", rendered)
        self.assertIn("type TaskRunNowParams = taskRunNowParams", rendered)
